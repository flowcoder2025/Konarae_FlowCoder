...
export const metadata: Metadata = {
  title: "FlowMate - 지원사업 전략 보드",
  description: "정부지원사업 공고의 조건, 혜택, 준비 전략을 로그인 없이 빠르게 확인하세요.",
};
...
export default async function HomePage() {
  ...
  const sections = [
    ...
    { title: "공고 해석 업데이트", projects: analyzed.projects },
  ];
    ...
    <main>
      <section className="border-b bg-muted/30">
        <div className="container mx-auto max-w-6xl px-4 py-16">
          <p className="mb-3 text-sm font-medium text-primary">FlowMate 지원사업 전략 보드</p>
          <h1 className="mb-5 max-w-3xl text-5xl font-bold tracking-tight">지원사업 공고, 읽는 시간은 줄이고 판단은 더 선명하게</h1>
          <p className="mb-8 max-w-2xl text-muted-foreground">조건, 혜택, 준비 전략, 리스크를 한 화면에서 정리해 지원 여부를 빠르게 판단할 수 있습니다.</p>
